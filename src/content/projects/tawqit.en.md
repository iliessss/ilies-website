...
**Shurūq** (sunrise) — the **first part of the Sun's upper limb** appears at the visible horizon, $h = h_0$:
...
**Maghrib** (sunset) — the **whole disk** disappears below the visible horizon, $h = h_0$, plus two precautionary minutes:
